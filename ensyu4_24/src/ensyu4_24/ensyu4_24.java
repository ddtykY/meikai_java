...
public class ensyu4_24 {
	...
	public static void main(String[] args) {
		...
		for (int countNumber = 2; countNumber <= integerValue; countNumber++) {
			...
			// "integerValue"が"countNumber"で割り切れる場合
			if (integerValue % countNumber == 0) {
