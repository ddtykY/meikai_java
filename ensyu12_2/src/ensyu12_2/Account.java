...
public class Account {
	...
	// Accountクラスのインスタンスを与えられた場合
	public Account(Account userAccount) {
		// 自身のコンストラクタを呼び出す
		this(userAccount.accountHolder, userAccount.accountNumber, userAccount.depositBalance);
	}
	...
	public String toString() {
		...
		return String.format("口座名義 : %s\n口座番号 : %s\n" +
				"預金残高 : %d円", accountHolder, accountNumber, depositBalance);
	}
	
	// 以降演習問題12-2のメソッド
	/*
	 * 関数名           :totalDeposit
	 * メソッドの説明   :合計の預金残高を返却する
	 * パラメータの説明 :なし
	 * 返り値           :depositBalance　預金残高
	 * 作成者           :山川勇輝
	 * 作成日           :2023.04.25
