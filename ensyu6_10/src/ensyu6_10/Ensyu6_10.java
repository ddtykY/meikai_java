...
public class Ensyu6_10 {
	...
	public static void main(String[] args) {
		...
		for (int indexArray = 0; indexArray < elementNumber; indexArray++) {
			...
			//indexArrayが0以外でintegerValueArray[indexArray]の値がひとつ前の要素と同じなら
			if(indexArray != 0 && integerValueArray[indexArray] == integerValueArray[indexArray-1]) {
